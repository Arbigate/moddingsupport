...
class ModdingSupport(commands.Cog):
    ...
    @commands.hybrid_command(name='skse')
    ...
    @commands.hybrid_command(name='ae')
    ...
    @commands.hybrid_command(name='downgrade')
    ...
    @commands.hybrid_command(name='porting', aliases=['converting', 'port', 'convert'])
    ...
    @commands.hybrid_command(name='crash')
    ...
    @commands.hybrid_command(name='modmanager')
    ...
    @commands.hybrid_command(name='reinstall')
    ...
    @commands.hybrid_command(name='laws')
    ...
    @commands.hybrid_command(name='nemesis')
    ...
    @commands.hybrid_command(name='dyndolod')
    ...
    @commands.hybrid_command(name='cleaning')
    ...
    @commands.hybrid_command(name='navmesh')
    ...
    @commands.hybrid_command(name='eslify')
    ...
    @commands.hybrid_command(name='vanillastart')
    ...
    @commands.hybrid_command(name='darkface')
    ...
    @commands.hybrid_command(name='loadorder', aliases=['loot'])
    ...
    @commands.hybrid_command(name='corrupt', aliases=['fallrim'])
    ...
    @commands.hybrid_command(name='essentials')
    ...
    @commands.hybrid_command(name='modlimit')
    ...
    @commands.hybrid_command(name='enb')
    ...
    @commands.hybrid_command(name='ini')
    ...
    @commands.hybrid_command(name='modlist')
    ...
    @commands.hybrid_command(name='ussep')
    ...
    @commands.hybrid_command(name='tudm')
    ...
    @commands.hybrid_command(name='synthesis')
    ...
    @commands.hybrid_command(name='xbox')
    ...
    @commands.hybrid_command(name='ps4')
    ...
    @commands.hybrid_command(name='sinitar')
